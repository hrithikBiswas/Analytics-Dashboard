...
const Sidebar: React.FC<SidebarProps> = memo(({ collapsed, onClose }) => {
    return (
        <>
            {/* Mobile Overlay */}
            {!collapsed && (
            ...
            <aside
                className={`
          fixed lg:sticky top-0 left-0 h-screen bg-white dark:bg-dark-900 border-r border-gray-200 dark:border-dark-700 
                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="h-16 flex items-center justify-between px-6 border-b border-gray-200 dark:border-dark-700">
                        ...
                        {!collapsed && (
                            <button
                                onClick={onClose}
                                className="lg:hidden p-1 hover:bg-gray-100 dark:hover:bg-dark-800 rounded-lg"
                            >
