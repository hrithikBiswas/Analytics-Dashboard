            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Customize your view with date range and user filters
                    </p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                    ...
                    <div className="relative">
                        ...
                        <select
                            ...
                            className="block w-full pl-3 pr-10 py-2 text-gray-700 border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm border rounded-md bg-white dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 cursor-pointer"
                        >
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                handleUserTypeChange(
                                    e.target.value as FilterState['userType'],
                                )
                            }
                            className="block w-full pl-3 pr-10 py-2 text-gray-700 border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm border rounded-md bg-white dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 cursor-pointer"
                        >
                    ...
                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                        {
                            userTypeOptions.find(
                                (option) => option.value === filters.userType,
                            )?.label
                        }
                    </span>
                </div>
